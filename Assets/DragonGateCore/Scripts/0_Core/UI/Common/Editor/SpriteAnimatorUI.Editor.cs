...
{
    [CustomEditor(typeof(SpriteAnimatorUI))]
    public class SpriteAnimatorUIEditor : UnityEditor.Editor
    {
        private SpriteAnimatorUI _animator;
        ...
        {
            if (target != null && target is SpriteAnimatorUI animator)
            {
                _animator = animator;
            ...
            {
                UnityEngine.Debug.LogWarning("SpriteAnimatorUIEditor: Target is null or invalid.");
            }
        }
