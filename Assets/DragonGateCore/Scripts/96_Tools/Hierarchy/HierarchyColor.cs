...
namespace DragonGate
{
    ...
    public static class HierarchyColorExtensions
    {
        public static void SetHierarchyColor(this GameObject go, Color color)
        {
            if (go == null) return;
            go.GetOrAddComponent<HierarchyColor>().BackgroundColor = color;
        }
    }
}
