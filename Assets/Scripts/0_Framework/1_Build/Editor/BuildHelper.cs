...
namespace Framework
{
    ...
    public static void BuildIOSRelease()
    {
        ...
        private static void Build(EBuildMode mode)
        {
            Debug.Log($"[DGBuild] Build Started : Mode - {mode.ToString()}");
		...
		return;
            ...
            Debug.Log($"[DGBuild] Build completed : {report.summary.result.ToString()}");
        }
    }
}