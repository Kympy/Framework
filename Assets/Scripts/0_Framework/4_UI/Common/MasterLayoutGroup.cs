...
namespace Framework
{
    ...
    public class MasterLayoutGroup : EngineObject
    {
        ...
        private void GatherComponents()
        {
            ...
            if (TryGetComponent(out LayoutGroup layoutGroup))
            {
                ...
                {
                    DGLog.LogError("Unsupported Layout Group type found. Please use HorizontalLayoutGroup, VerticalLayoutGroup, or GridLayoutGroup.");
